...
- `checkable_signins`, `checkable_signups`, `seeable_watchers`, `more_watchers`, `my_seeable_works`, `more_of_seeable_works`, `seeable_artists`, `more_artists`, `seeable_works`, `more_works`, `viewable_users`, `viewable_artists`, `viewable_works_of_artist`: Views for various read operations related to users, artists, and works.
...
- `check_login`, `see_watchers`, `see_more_users`, `see_works`, `see_more_works`, `see_watched_artists`, `see_more_artists`, `see_liked_works`, `see_more_works`: View procedures for various read operations related to users, artists, and works.
